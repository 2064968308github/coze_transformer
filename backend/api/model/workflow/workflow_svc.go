...
type WorkflowService interface {
	...
	// Export workflow
	ExportWorkflow(ctx context.Context, request *ExportWorkflowRequest) (r *ExportWorkflowResponse, err error)
	// Open API
...
func (p *WorkflowServiceClient) ExportWorkflow(ctx context.Context, request *ExportWorkflowRequest) (r *ExportWorkflowResponse, err error) {
	var _args WorkflowServiceExportWorkflowArgs
	_args.Request = request
	var _result WorkflowServiceExportWorkflowResult
	if err = p.Client_().Call(ctx, "ExportWorkflow", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewWorkflowServiceProcessor(handler WorkflowService) *WorkflowServiceProcessor {
	...
	self.AddToProcessorMap("ExportWorkflow", &workflowServiceProcessorExportWorkflow{handler: handler})
...
type workflowServiceProcessorExportWorkflow struct {
	handler WorkflowService
}

func (p *workflowServiceProcessorExportWorkflow) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := WorkflowServiceExportWorkflowArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("ExportWorkflow", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := WorkflowServiceExportWorkflowResult{}
	var retval *ExportWorkflowResponse
	if retval, err2 = p.handler.ExportWorkflow(ctx, args.Request); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing ExportWorkflow: "+err2.Error())
		oprot.WriteMessageBegin("ExportWorkflow", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("ExportWorkflow", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type WorkflowServiceExportWorkflowArgs struct {
	Request *ExportWorkflowRequest `thrift:"request,1"`
}

func NewWorkflowServiceExportWorkflowArgs() *WorkflowServiceExportWorkflowArgs {
	return &WorkflowServiceExportWorkflowArgs{}
}

func (p *WorkflowServiceExportWorkflowArgs) InitDefault() {
}

var WorkflowServiceExportWorkflowArgs_Request_DEFAULT *ExportWorkflowRequest

func (p *WorkflowServiceExportWorkflowArgs) GetRequest() (v *ExportWorkflowRequest) {
	if !p.IsSetRequest() {
		return WorkflowServiceExportWorkflowArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_WorkflowServiceExportWorkflowArgs = map[int16]string{
	1: "request",
}

func (p *WorkflowServiceExportWorkflowArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *WorkflowServiceExportWorkflowArgs) Read(iprot thrift.TProtocol) (err error) {
	var fieldTypeId thrift.TType
	var fieldId int16
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_WorkflowServiceExportWorkflowArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *WorkflowServiceExportWorkflowArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewExportWorkflowRequest()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Request = _field
...
func (p *WorkflowServiceExportWorkflowArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ExportWorkflow_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *WorkflowServiceExportWorkflowArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *WorkflowServiceExportWorkflowArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("WorkflowServiceExportWorkflowArgs(%+v)", *p)

}

type WorkflowServiceExportWorkflowResult struct {
	Success *ExportWorkflowResponse `thrift:"success,0,optional"`
}

func NewWorkflowServiceExportWorkflowResult() *WorkflowServiceExportWorkflowResult {
	return &WorkflowServiceExportWorkflowResult{}
}

func (p *WorkflowServiceExportWorkflowResult) InitDefault() {
}

var WorkflowServiceExportWorkflowResult_Success_DEFAULT *ExportWorkflowResponse

func (p *WorkflowServiceExportWorkflowResult) GetSuccess() (v *ExportWorkflowResponse) {
	if !p.IsSetSuccess() {
		return WorkflowServiceExportWorkflowResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_WorkflowServiceExportWorkflowResult = map[int16]string{
	0: "success",
}

func (p *WorkflowServiceExportWorkflowResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *WorkflowServiceExportWorkflowResult) Read(iprot thrift.TProtocol) (err error) {
	var fieldTypeId thrift.TType
	var fieldId int16
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_WorkflowServiceExportWorkflowResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *WorkflowServiceExportWorkflowResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewExportWorkflowResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
...
func (p *WorkflowServiceExportWorkflowResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("ExportWorkflow_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *WorkflowServiceExportWorkflowResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *WorkflowServiceExportWorkflowResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("WorkflowServiceExportWorkflowResult(%+v)", *p)
